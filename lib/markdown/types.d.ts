...
export { Node, Parent as UnistParent, Literal as UnistLiteral } from 'unist';
...
export interface Reference extends Association {
  // https://github.com/syntax-tree/mdast#referencetype
...
// Custom Node
export interface HighlightedCode extends Node {
...
export type Content = Root | TopLevelContent | ListContent | TableContent | RowContent | PhrasingContent;
